...
SELECT id, id_paciente, id_medico FROM receta;
SELECT codigo FROM medicamento;

ALTER TABLE receta ADD COLUMN id_farmaceutico VARCHAR(20) NULL;
ALTER TABLE receta ADD FOREIGN KEY (id_farmaceutico) REFERENCES usuario(id);
